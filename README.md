...
An event occurs when the user interacts with the page
...
You would convert node lists to arrays because then you can use methods that are available to arrays
